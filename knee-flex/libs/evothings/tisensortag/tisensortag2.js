/**
 * File: tisensortag2.js
 * Description: JavaScript library for the TI SensorTag2.
 * Author: Miki
 */
...
evothings.tisensortag2 = (function()
{
	var sensortag2 = {}

	sensortag2.DEVICEINFO_SERVICE = '0000180a-0000-1000-8000-00805f9b34fb'
	sensortag2.FIRMWARE_DATA = '00002a26-0000-1000-8000-00805f9b34fb'

	sensortag2.IRTEMPERATURE_SERVICE = 'f000aa00-0451-4000-b000-000000000000'
	sensortag2.IRTEMPERATURE_DATA = 'f000aa01-0451-4000-b000-000000000000'
	sensortag2.IRTEMPERATURE_CONFIG = 'f000aa02-0451-4000-b000-000000000000'
	sensortag2.IRTEMPERATURE_PERIOD = 'f000aa03-0451-4000-b000-000000000000'
	sensortag2.IRTEMPERATURE_NOTIFICATION = '00002902-0000-1000-8000-00805f9b34fb'

	sensortag2.ACCELEROMETER_SERVICE = 'f000aa10-0451-4000-b000-000000000000'
	sensortag2.ACCELEROMETER_DATA = 'f000aa11-0451-4000-b000-000000000000'
	sensortag2.ACCELEROMETER_CONFIG = 'f000aa12-0451-4000-b000-000000000000'
	sensortag2.ACCELEROMETER_PERIOD = 'f000aa13-0451-4000-b000-000000000000'
	sensortag2.ACCELEROMETER_NOTIFICATION = '00002902-0000-1000-8000-00805f9b34fb'

	sensortag2.HUMIDITY_SERVICE = 'f000aa20-0451-4000-b000-000000000000'
	sensortag2.HUMIDITY_DATA = 'f000aa21-0451-4000-b000-000000000000'
	sensortag2.HUMIDITY_CONFIG = 'f000aa22-0451-4000-b000-000000000000'
	sensortag2.HUMIDITY_PERIOD = 'f000aa23-0451-4000-b000-000000000000'
	sensortag2.HUMIDITY_NOTIFICATION = '00002902-0000-1000-8000-00805f9b34fb'

	sensortag2.MAGNETOMETER_SERVICE = 'f000aa30-0451-4000-b000-000000000000'
	sensortag2.MAGNETOMETER_DATA = 'f000aa31-0451-4000-b000-000000000000'
	sensortag2.MAGNETOMETER_CONFIG = 'f000aa32-0451-4000-b000-000000000000'
	sensortag2.MAGNETOMETER_PERIOD = 'f000aa33-0451-4000-b000-000000000000'
	sensortag2.MAGNETOMETER_NOTIFICATION = '00002902-0000-1000-8000-00805f9b34fb'

	sensortag2.BAROMETER_SERVICE = 'f000aa40-0451-4000-b000-000000000000'
	sensortag2.BAROMETER_DATA = 'f000aa41-0451-4000-b000-000000000000'
	sensortag2.BAROMETER_CONFIG = 'f000aa42-0451-4000-b000-000000000000'
	sensortag2.BAROMETER_CALIBRATION = 'f000aa43-0451-4000-b000-000000000000'
	sensortag2.BAROMETER_PERIOD = 'f000aa44-0451-4000-b000-000000000000'
	sensortag2.BAROMETER_NOTIFICATION = '00002902-0000-1000-8000-00805f9b34fb'

	sensortag2.GYROSCOPE_SERVICE = 'f000aa50-0451-4000-b000-000000000000'
	sensortag2.GYROSCOPE_DATA = 'f000aa51-0451-4000-b000-000000000000'
	sensortag2.GYROSCOPE_CONFIG = 'f000aa52-0451-4000-b000-000000000000'
	sensortag2.GYROSCOPE_PERIOD = 'f000aa53-0451-4000-b000-000000000000'
	sensortag2.GYROSCOPE_NOTIFICATION = '00002902-0000-1000-8000-00805f9b34fb'

	sensortag2.KEYPRESS_SERVICE = '0000ffe0-0000-1000-8000-00805f9b34fb'
	sensortag2.KEYPRESS_DATA = '0000ffe1-0000-1000-8000-00805f9b34fb'
	sensortag2.KEYPRESS_NOTIFICATION = '00002902-0000-1000-8000-00805f9b34fb'

	/**
	 * Internal. Override if needed.
	 */
	sensortag2.deviceIsSensorTag = function(device)
	{
		return (device != null) &&
			(device.name != null) &&
	 ...
	 * For debugging.
	 */
	sensortag2.logServices = function(device)
	{
	 ...
	 */
	sensortag2.createInstance = function()
	{
		/**
		...
		instance.irTemperatureCallback = function(fun, interval)
		{
			...
			instance.requiredServices.push(sensortag2.IRTEMPERATURE_SERVICE)
		...
		instance.accelerometerCallback = function(fun, interval)
		{
			...
			instance.requiredServices.push(sensortag2.ACCELEROMETER_SERVICE)
		...
		instance.humidityCallback = function(fun)
		{
			...
			instance.requiredServices.push(sensortag2.HUMIDITY_SERVICE)
		...
		instance.magnetometerCallback = function(fun, interval)
		{
			...
			instance.requiredServices.push(sensortag2.MAGNETOMETER_SERVICE)
		...
		instance.barometerCallback = function(fun, interval)
		{
			...
			instance.requiredServices.push(sensortag2.BAROMETER_SERVICE)
		...
		instance.gyroscopeCallback = function(fun, interval, axes)
		{
			...
			instance.requiredServices.push(sensortag2.GYROSCOPE_SERVICE)
		...
		instance.keypressCallback = function(fun)
		{
			...
			instance.requiredServices.push(sensortag2.KEYPRESS_SERVICE)
		...
		instance.connectToClosestDevice = function()
		{
			...
			evothings.easyble.startScan(
				function(device)
				{
					...
					if (sensortag2.deviceIsSensorTag(device)
		...
		instance.activateSensors = function()
		{
			...
			//sensortag2.logServices(instance.device)
			//console.log('---------------------- END -----------------------')
		...
		{
			instance.sensorOn(
				sensortag2.IRTEMPERATURE_CONFIG,
				instance.irTemperatureConfig,
				sensortag2.IRTEMPERATURE_PERIOD,
				instance.irTemperatureInterval,
				sensortag2.IRTEMPERATURE_DATA,
				sensortag2.IRTEMPERATURE_NOTIFICATION,
		...
		{
			instance.sensorOff(sensortag2.IRTEMPERATURE_DATA)
		...
		{
			instance.sensorOn(
				sensortag2.ACCELEROMETER_CONFIG,
				instance.accelerometerConfig,
				sensortag2.ACCELEROMETER_PERIOD,
				instance.accelerometerInterval,
				sensortag2.ACCELEROMETER_DATA,
				sensortag2.ACCELEROMETER_NOTIFICATION,
		...
		{
			instance.sensorOff(sensortag2.ACCELEROMETER_DATA)
		...
		{
			instance.sensorOn(
				sensortag2.HUMIDITY_CONFIG,
				instance.humidityConfig,
				null, // Not used.
				null, // Not used.
				sensortag2.HUMIDITY_DATA,
				sensortag2.HUMIDITY_NOTIFICATION,
		...
		{
			instance.sensorOff(sensortag2.HUMIDITY_DATA)
		...
		{
			instance.sensorOn(
				sensortag2.MAGNETOMETER_CONFIG,
				instance.magnetometerConfig,
				sensortag2.MAGNETOMETER_PERIOD,
				instance.magnetometerInterval,
				sensortag2.MAGNETOMETER_DATA,
				sensortag2.MAGNETOMETER_NOTIFICATION,
		...
		{
			instance.sensorOff(sensortag2.MAGNETOMETER_DATA)
		...
		{
			instance.sensorOn(
				sensortag2.BAROMETER_CONFIG,
				instance.barometerConfig,
				sensortag2.BAROMETER_PERIOD,
				instance.barometerInterval,
				sensortag2.BAROMETER_DATA,
				sensortag2.BAROMETER_NOTIFICATION,
		...
		{
			instance.sensorOff(sensortag2.BAROMETER_DATA)
		...
		{
			instance.sensorOn(
				sensortag2.GYROSCOPE_CONFIG,
				instance.gyroscopeConfig,
				sensortag2.GYROSCOPE_PERIOD,
				instance.gyroscopeInterval,
				sensortag2.GYROSCOPE_DATA,
				sensortag2.GYROSCOPE_NOTIFICATION,
		...
		{
			instance.sensorOff(sensortag2.GYROSCOPE_DATA)
		...
		instance.keypressOn = function()
		{
			instance.sensorOn(
				...
				null, // Not used.
				null, // Not used.
				sensortag2.KEYPRESS_DATA,
				sensortag2.KEYPRESS_NOTIFICATION,
		...
		{
			instance.sensorOff(sensortag2.KEYPRESS_DATA)
